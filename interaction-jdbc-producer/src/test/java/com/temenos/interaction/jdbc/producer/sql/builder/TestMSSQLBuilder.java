...
public class TestMSSQLBuilder {
    ...
    public void testGetCommandWithAlias() {
        ...
        selects.add(new ComparableFieldName("col1" + JDBCProducerConstants.SELECT_FIELD_NAME_ALIAS_SEP + "Column No 1")); // Valid
                                                                                                                          // Alias
        selects.add(new ComparableFieldName("col2")); // No Alias
        selects.add(new ComparableFieldName("col3" + JDBCProducerConstants.SELECT_FIELD_NAME_ALIAS_SEP + "Column3")); // /
                                                                                                                      // Valid
                                                                                                                      // Alias
        selects.add(new ComparableFieldName("col4" + JDBCProducerConstants.SELECT_FIELD_NAME_ALIAS_SEP + "")); // Empty
                                                                                                               // Alias
        AccessProfile accessProfile = new AccessProfile(filters, selects);
        ...
        // Get the command.
        String actualCommand = builder.getCommand();
        assertEquals("SELECT \"col1\" AS \"Column No 1\", \"col2\", \"col3\" AS \"Column3\", \"col4\" FROM \""
                + TEST_TABLE_NAME + "\""
    ...
    public void testGetCommandComplex() {
        ...
        SqlBuilder builder = null;
        try {
            builder = SqlBuilderFactory.getSqlBuilder(TEST_TABLE_NAME, keyValue, accessProfile, columnTypesMap, "2",
                    "3", orderBy, ServerMode.MSSQL);
        } catch (Exception e) {
            fail();
        }
        ...
        assertEquals("SELECT * FROM \"" + TEST_TABLE_NAME
                + "\" WHERE \"col1\"='aKeyValue' ORDER BY \"col1\", \"col2\" DESC "
                + "OFFSET 3 ROWS FETCH NEXT 2 ROWS ONLY", actualCommand);
    }
    ...
    public void testGetCommandNullFilter() throws Exception {
        ...
        try {
            builder = SqlBuilderFactory.getSqlBuilder(TEST_TABLE_NAME, null, accessProfile, mock(ColumnTypesMap.class),
                    null, null, null, ServerMode.MSSQL);
        } catch (Exception e) {
            fail();
        }
    ...
    public void testReservedRnCommand() {
        ...
        // Create the builder
        try {
            SqlBuilderFactory.getSqlBuilder(TEST_TABLE_NAME, null, null, columnTypesMap, null, null, null,
                    ServerMode.MSSQL);
        } catch (Exception e) {
            fail();
        }
