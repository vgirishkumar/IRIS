...
public class TestSqlComamndBuilder {
     ...
     */
    @Test
    @Ignore("The test verifies literally the SQL generated by command builder, however this in turn request columns in the order implied by order of returning values of the Set - this is not guaranteed and fails on some JVMs")
