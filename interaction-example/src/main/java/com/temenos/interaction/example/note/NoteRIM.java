 ...
 */
@Path("/notes/{id}")
public class NoteRIM extends CRUDResourceInteractionModel implements ResourcePutCommand, ResourceDeleteCommand {
	...
	public NoteRIM() {
		...
		commandController.addGetCommand(RESOURCE_PATH, new GetOEntityNoteCommand(producer));
