...
*/
	...
	public void testPOSTNextNoteIDXML() throws Exception {
		...
		String expectedXML = "<resource href=\"http://localhost:8080/example/rest/notes/new\"><link href=\"PUT http://localhost:8080/example/rest/notes/" + nextIDStr + "\" rel=\"note.exists\" name=\"ID.new>note.exists\"/><lastId>" + nextIDStr + "</lastId></resource>";
