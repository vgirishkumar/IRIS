...
public class TestMetadataProvider {
	...
	public void testWriteMetadataResource() throws Exception {
		...
		p.writeTo(mr, MetaDataResource.class, Metadata.class, null, com.temenos.interaction.core.media.hal.MediaType.APPLICATION_HAL_JSON_TYPE, null, bos);
	...
	public void testWriteMetadataResourceGenericEntity() throws Exception {
		...
		MetaDataProvider p = new MetaDataProvider();
		ByteArrayOutputStream bos = new ByteArrayOutputStream();
		p.writeTo(ge.getEntity(), ge.getRawType(), ge.getType(), null, com.temenos.interaction.core.media.hal.MediaType.APPLICATION_HAL_JSON_TYPE, null, bos);
