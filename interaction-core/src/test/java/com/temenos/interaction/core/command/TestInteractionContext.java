...
public class TestInteractionContext {
	...
	public void testAttributes() {
		InteractionContext ctx = new InteractionContext(new MultivaluedMapImpl(), new MultivaluedMapImpl(), new ResourceState("entity", "initial_state", new ArrayList<Action>(), "/resource"), mock(Metadata.class));
