...
public class TestInteractionContext {
	...
	public void testResolveIdDefault() {
		...
		InteractionContext ctx = new InteractionContext(pathParameters, new MultivaluedMapImpl(), new ResourceState("entity", "initial_state", "/resource"));
	...
	public void testResolveIdParameter() {
		...
		ResourceState state = new ResourceState("entity", "initial_state", "/resource", "TheTestParameterKey");
