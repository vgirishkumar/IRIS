...
public class ResourceStateMachine {
     ...
     * @param method The HTTP method associated with the state, this is important
    ...
    public Map<String, Set<String>> getInteractionByPath() {
        return optimizationMappings.getInformationFrom(InformationType.INTERACTIONS_BY_PATH);
    }
    ...
    public Map<String, Set<String>> getInteractionByState() {
        return optimizationMappings.getInformationFrom(InformationType.INTERACTIONS_BY_STATE_NAME);
    }
    ...
    public Map<String, Set<ResourceState>> getResourceStatesByPath() {
        return optimizationMappings.getInformationFrom(InformationType.RESOURCE_STATES_BY_PATH);
    }
    ...
    public Map<String, ResourceState> getResourceStateByName() {
        return optimizationMappings.getInformationFrom(InformationType.RESOURCE_STATES_BY_NAME);
    }
    ...
    public Map<String, Transition> getTransitionsById() {
        return optimizationMappings.getInformationFrom(InformationType.TRANSITIONS_BY_ID);
    }

    public Map<String, Transition> getTransitionsByRel() {
        return optimizationMappings.getInformationFrom(InformationType.TRANSITIONS_BY_REL);
    }
