 ...
 */
public class InfoFeedbackPanel extends Panel implements IFeedback {
	/**
	 * List for messages.
	 */
	 ...
	 * @see org.apache.wicket.Component#Component(String)
	 */
	public InfoFeedbackPanel(final String id) {
		this(id, null);
	}
	 ...
	 * @param filter
	 */
	public InfoFeedbackPanel(final String id, IFeedbackMessageFilter filter) {
		super(id);
	 ...
	 */
	public final InfoFeedbackPanel setFilter(IFeedbackMessageFilter filter) {
	 ...
	 * @return FeedbackPanel this.
	 */
	public final InfoFeedbackPanel setMaxMessages(int maxMessages) {
	 ...
	 * @return FeedbackPanel this.
	 */
	public final InfoFeedbackPanel setSortingComparator(Comparator<FeedbackMessage> sortingComparator) {
	...
	protected Component newMessageDisplayComponent(String id, FeedbackMessage message) {
		...
		label.setEscapeModelStrings(InfoFeedbackPanel.this.getEscapeModelStrings());
		return label;
	}
}
