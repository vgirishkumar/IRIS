...
import com.temenos.ebank.pages.clientAquisition.step1.Step1IBSA;
...
public class IBSAWizard extends ClientAquisitionWizard {

	private static final long serialVersionUID = 1L;

	public IBSAWizard(String id, Application a) {
		super(id, a);
	}
	...
	protected List getProductSpecificSteps() {
		return Arrays.asList(new Class[] { Step1IBSA.class, Step2.class, Step3.class, Step4.class, Step5.class,
				Step6.class });
	}
