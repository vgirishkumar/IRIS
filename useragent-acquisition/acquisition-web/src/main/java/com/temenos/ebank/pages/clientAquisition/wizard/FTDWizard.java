...
public class FTDWizard extends ClientAquisitionWizard {
	...
	public FTDWizard(String id, Application a) {
		super(id, a);
	}
	...
	protected List getProductSpecificSteps() {
		return Arrays.asList(new Class[] { Step1FTD.class, Step2.class, Step3.class,
				Step4FTD.class, Step5.class, Step6.class });
	}
	@Override
