 ...
 * has common functionality like a next, previous, finish and cancel button, and it uses a {@link IWizardModel} to
 * navigate through the steps.
 * <p>
 * Before you can use the wizard component, it needs to be initialized with a model. You do this by calling
 * {@link #init(IWizardModel)} with the wizard model you intend to use.
 * </p>
 * 
 * <p>
 * This default implementation should be useful for basic cases, if the layout is exactly what you need. If you want to
 * provide your own layout and/ or have more or less components (e.g. you want to additionally provide an overview
 * component), you can override this class and add the components you want yourself using methods like
 * {@link #newButtonBar(String)} et-cetera.
 * </p>
 * 
 * @author Eelco Hillenius
 */
public class EbankWizard extends Panel implements IWizardModelListener, IWizard {
	 ...
	 * <p>
	 * If you override this class, it makes sense to call this constructor (super(id)), then - in your constructor -
	 * construct a transition model and then call {@link #init(IWizardModel)} to initialize the wizard.
	 * </p>
	 * <p>
	 ...
	 */
	public EbankWizard(String id, boolean addDefaultCssStyle) {
		super(id);
	 ...
	 */
	public EbankWizard(String id, EbankWizardModel wizardModel) {
	 ...
	 *            Whether to add the {@link #addDefaultCssStyle() default style}
	 */
	public EbankWizard(String id, EbankWizardModel wizardModel, boolean addDefaultCssStyle) {
		super(id);
	 ...
	 */
	public final EbankWizardModel getWizardModel() {
		return wizardModel;
	}
	...
	public void onActiveStepChanged(IWizardStep newStep) {
		// cleanup form validators from previous steps
		Collection<IFormValidator> formValidators = form.getFormValidators();
		if (formValidators != null) {
			for (IFormValidator formValidator : formValidators) {
				form.remove(formValidator);
			}
		}
	 ...
	 * <p>
	 * If you constructed this wizard using a constructor without the transitions model argument, <strong>you
	 * must</strong> call this method prior to actually using it.
	 * </p>
	 * 
	 * @param wizardModel
	 */
	protected void init(EbankWizardModel wizardModel) {
		if (wizardModel == null) {
		...
		// feedback panel comes in last because it needs access to the button bar
	...
	protected Component newButtonBar(String id) {
		...
		return new EbankButtonBar(id, this);
	}
