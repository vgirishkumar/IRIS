...
import com.temenos.ebank.pages.clientAquisition.step1.Step1RASA;
...
public class RASAWizard extends ClientAquisitionWizard {
	...
	public RASAWizard(String id, Application a) {
		super(id, a);
	}
	...
	protected List getProductSpecificSteps() {
		return Arrays.asList(new Class[] { Step1RASA.class, Step2.class, Step3.class, Step4.class, Step5.class,
				Step6.class });
	}
